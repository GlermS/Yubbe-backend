...
exports.removeUserFromCall = exports.addUserToCall = exports.deleteCall = exports.editCall = void 0;
...
function removeUserFromCall(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var handler, respo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handler = new calls_1.AdmCallsHandler();
                    return [4 /*yield*/, handler.removeUserFromCall(req)];
                case 1:
                    respo = _a.sent();
                    res.status(respo.code).json(respo.data);
                    return [2 /*return*/];
