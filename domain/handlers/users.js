...
exports.AdmUsersHandler = void 0;
var token_authentication_1 = require("../validation/token-authentication");
var mongodb_1 = require("../database/DB/mongodb/mongodb");
var AdmUsersHandler = /** @class */ (function () {
    function AdmUsersHandler() {
        var _this = this;
        this.code = { authorized: 200 };
        this.listUsers = function (req) { return __awaiter(_this, void 0, void 0, function () {
            var auth, db, respo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        auth = this.authenticateData(req);
                        if (!(auth.code === this.code.authorized)) return [3 /*break*/, 2];
        ...
        this.updateUser = function (req) { return __awaiter(_this, void 0, void 0, function () {
            var auth, userData, db, user, respo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        auth = this.authenticateData(req);
        ...
        this.changeUserPassword = function (req) { return __awaiter(_this, void 0, void 0, function () {
            var auth, userData, db, respo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        auth = this.authenticateData(req);
        ...
        this.deleteUser = function (req) { return __awaiter(_this, void 0, void 0, function () {
            var auth, db, respo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    return AdmUsersHandler;
}());
exports.AdmUsersHandler = AdmUsersHandler;
