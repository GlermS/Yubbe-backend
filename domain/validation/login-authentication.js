            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        if (data.approved) {
                            return [2 /*return*/, { approved: true, name: data.name, authToken: jwt.sign({ name: data.name, id: data.id, authorization: data.authorization }, 'ANAPIENAPWIEHAEPFAPEFAÇENFAJEJFNLALMALMFWEMWK', { expiresIn: '1h' }) }];
                        }
                        else {
